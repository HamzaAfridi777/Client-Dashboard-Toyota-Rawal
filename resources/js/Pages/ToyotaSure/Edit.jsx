...
const Edit = () => {
    ...
    useEffect(() => {
        ...
        if (toyotasures) {
            setForm({
                description:toyotasures.description || "",
                heading1:toyotasures.heading1 || "",
                note1: toyotasures.note1 || "",
                heading2:toyotasures.heading2 || "",
                note2: toyotasures.note2 || "",
                heading3:toyotasures.heading3 || "",
                note3: toyotasures.note3 || "",
    ...
    const handleSubmit = (event) => {
        ...
        Inertia.post(route("toyota_sure.update", toyotasures.id), formData, {
            onError: (errors) => {
                console.log(errors);
            },
            onSuccess: () => {
